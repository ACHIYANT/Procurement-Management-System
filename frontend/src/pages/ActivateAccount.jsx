...
export default function ActivateAccount() {
  ...
  const verifyUrl = toProcurementApiUrl("/account-activation/validate");
  const executeUrl = toProcurementApiUrl("/account-activation/execute");
      ...
      return buildDiagnosticPresentation(
        {
          ...
          details: payload?.details || payload?.data?.details,
        },
        fallbackMessage,
      );
    } catch {
      ...
      const fallbackDetail = buildDiagnosticPresentation(
        {
          ...
          message: buildDisplayMessage(
            { status: 0, url: verifyUrl, message: error?.message },
            "Unable to reach the Procurement service. Please try again.",
          ),
        },
        "Unable to reach the Procurement service. Please try again.",
      );
      ...
      const fallbackDetail = buildDiagnosticPresentation(
        {
          ...
          url: executeUrl,
          message: buildDisplayMessage(
            { status: 0, url: executeUrl, message: error?.message },
            "Unable to reach the Procurement service. Please try again.",
          ),
        },
        "Unable to reach the Procurement service. Please try again.",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(14,116,144,0.2),_transparent_30%),linear-gradient(135deg,#f8fafc_0%,#eef7ff_45%,#f8fbff_100%)] px-4 py-3 lg:py-2.5">
      ...
      <Motion.div
        ...
        className="relative mx-auto flex min-h-[calc(100vh-1.5rem)] max-w-6xl items-center justify-center"
      >
        <div className="grid w-full gap-2 lg:grid-cols-[0.98fr_0.96fr]">
          <section className="hidden rounded-[2rem] border border-white/70 bg-white/60 px-5 pb-3.5 pt-3.5 shadow-[0_30px_80px_-38px_rgba(15,23,42,0.45)] backdrop-blur-xl lg:flex lg:flex-col lg:justify-start lg:gap-3">
            <div>
              <div className="mb-2 flex items-center gap-4">
                <img src={logo} alt="PMS Logo" width={84} height={44} />
                <img src={govt} alt="Government Logo" width={188} height={100} />
              </div>
              ...
              <h1 className="mt-1.5 max-w-xl text-[1.62rem] font-semibold leading-tight text-slate-900">
                Claim your PMS access using your employee record.
              </h1>
              <p className="mt-1 max-w-xl text-[12.5px] leading-[1.15rem] text-slate-600">
                We verify your employee code and registered mobile number
                against the Procurement employee master, then create your sign-in
                access from trusted data already held by the system.
              </p>
            </div>

            <div className="rounded-2xl border border-slate-200/80 bg-white/75 p-2.5 shadow-sm lg:mt-2.5">
              ...
              <div className="grid gap-1.5">
                <div className="grid grid-cols-[1.7rem_1fr] items-start gap-2.5 rounded-xl bg-slate-50/85 px-2.5 py-1.5">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[11.5px] leading-[1rem] text-slate-600">
                      Match your employee code with the mobile number already
                      saved in the Procurement employee master.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-[1.7rem_1fr] items-start gap-2.5 rounded-xl bg-slate-50/85 px-2.5 py-1.5">
                  <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-cyan-600 text-[10px] font-semibold text-white">
                    2
                  </span>
                  <div>
                    <p className="text-[12.5px] font-semibold text-slate-900">
                    ...
                    <p className="mt-0.5 text-[11.5px] leading-[1rem] text-slate-600">
                      ...
                      from the official procurement employee record.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-[1.7rem_1fr] items-start gap-2.5 rounded-xl bg-slate-50/85 px-2.5 py-1.5">
            ...
            <div className="grid gap-2 sm:grid-cols-2 lg:mt-2.5">
              <div className="flex h-full flex-col justify-between rounded-2xl border border-slate-200 bg-white/80 p-2.5">
                <div>
                  <div className="mb-1 inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-slate-900 text-white">
                ...
                <p className="mt-1 text-[12px] leading-[1rem] text-slate-600">
                  Your employee code and registered mobile number are checked
                  first. You do not need to type name, designation, or division manually.
                </p>
              </div>
              <div className="flex h-full flex-col justify-between rounded-2xl border border-slate-200 bg-white/80 p-2.5">
                <div>
                  <div className="mb-1 inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-emerald-600 text-white">
                ...
                <p className="mt-1 text-[12px] leading-[1rem] text-slate-600">
                  ...
                  immediately and then return to login with a normal private credential.
                </p>
              </div>
            </div>
          </section>
          ...
          <Card className="overflow-hidden rounded-[2rem] border border-white/80 bg-white/85 shadow-[0_34px_90px_-42px_rgba(15,23,42,0.5)] backdrop-blur-xl">
            <CardContent className="p-0 lg:flex lg:flex-col">
              <div className="border-b border-slate-200/80 bg-gradient-to-r from-slate-950 via-slate-900 to-cyan-950 px-6 py-2.5 text-white sm:px-7">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.22em] text-cyan-200">
                      Public Activation Flow
                    </p>
                    <h2 className="mt-1 text-[1.35rem] font-semibold leading-tight">
                      Activate Your Account
                    </h2>
                    <p className="mt-0.5 max-w-lg text-[12px] leading-[1rem] text-slate-200/90">
              ...
              <div className="space-y-2.5 px-6 py-3 sm:px-7">
                ...
                {verifiedEmployee ? (
                  <div className="rounded-2xl border border-emerald-200 bg-emerald-50/80 p-2">
                    ...
                    <div className="grid gap-2 rounded-xl bg-white/90 p-2 shadow-sm lg:grid-cols-[1.1fr_0.9fr_0.8fr]">
                      <div className="min-w-0">
                        ...
                        <p className="mt-0.5 flex items-center gap-2 truncate text-sm font-semibold text-slate-900">
                          ...
                          <span className="truncate">
                            {verifiedEmployee?.employee_name || "Not available"}
                          </span>
                        </p>
                      </div>
                      <div className="min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="mt-0.5 flex items-center gap-2 truncate text-sm text-slate-700">
                          ...
                          <span className="truncate">
                            {formatLabel(verifiedEmployee?.location_scope)}
                          </span>
                        </p>
                      </div>
                    </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50/85 p-2.5">
                  ...
                  <div className="grid gap-2 lg:grid-cols-[0.98fr_1.02fr] lg:items-start">
                    <div className="grid gap-1.5">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-700">
                          New password
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white/90 p-2">
