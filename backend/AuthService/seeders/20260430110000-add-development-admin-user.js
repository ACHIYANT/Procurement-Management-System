...
const DUMMY_USER = {
  empcode: "PMSADMIN001",
  fullname: "PMS Dummy Admin",
  mobileno: "9876543210",
  designation: "Procurement Administrator",
  department: "Procurement",
  location_scope: "HQ",
};

const DUMMY_PASSWORD = process.env.PMS_DUMMY_ADMIN_PASSWORD || "Procure@123";
const DUMMY_ROLES = ["SUPER_ADMIN", "ADMIN", "PROCUREMENT_OFFICER"];
